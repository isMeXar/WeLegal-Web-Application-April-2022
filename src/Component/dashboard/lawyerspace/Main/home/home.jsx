                      ...
                      <div className="project-box" >
                        <div className="project-box-header">
                          ...
                          <button className='case_bt add_appoint_cs'>
                              <NavLink to='/Lawyer/Dashboard/AddAppointement'/* {`/Lawyer/Dashboard/AddAppointement/${clients.id}` */ className="case_app">Add Appointement</NavLink>
                            </button>
                            <button className='case_bt update_cs'>
                              <NavLink to='/Lawyer/Dashboard/View'/* {`/Lawyer/Dashboard/View/${clients.id}`} */ className="case_up">View / Update</NavLink>
                            </button>
                          </div>
                        </div>
                        <div className="project-box-content-header">
                          <div className='caseinfo_left'>
                            ...
                            <p className='client_n'><span>Client: </span>Adriouich Abdelilah</p>
                            <p className='client_n'><span>Status :</span> Active</p>
                          </div>
