                            ...
                            <div className="profile-tab-nav border-right">
                                <div className="p-4">
                                    <div className="img-circle text-center mb-3">
                                        <img className='client_img' src="https://assets.codepen.io/3306515/IMG_2025.jpg" alt="profile image" />
                                    </div>
                                    <h4 className="text-center">{clients.name}</h4>
                                </div>
                                <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <NavLink to="/Lawyer/Dashboard/Settings/Personel" className="nav-link" id="account-tab" data-toggle="pill" role="tab" aria-controls="account" aria-selected="true">
