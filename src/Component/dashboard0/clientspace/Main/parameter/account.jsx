...
const Account = () => {
    ...
    const parameterSubmit = (e) => {
        ...
        const data = {
            username: parameterInput.username,
                        ...
                        <div className="bg-white  d-sm-flex">
                            <div className="profile-tab-nav border-right">
                                <div className="p-4">
                                    ...
                                    <h4 className="text-center">Adriouich Abdelilah</h4>
                                </div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="form-group form-group-par">
                                                    <label>Name</label>
                                                    <input type="text" className="form-control" onChange={handleInput} value={parameterInput.username} name="username" />
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group form-group-par">
