  ...
  return (
    <div className="app-content">
      <div className="app-sidebar">
        <NavLink to='/lawyerhome/home' className="app-sidebar-link ">
        ...
        <NavLink to='/lawyerhome/client' className="app-sidebar-link ">
          <FiUsers className='client_icon' />
        </NavLink>
        <NavLink to="/lawyerhome/chat" className="app-sidebar-link">
        ...
        <NavLink to="/lawyerhome/Appointement" className="app-sidebar-link">
        ...
        <NavLink to="/lawyerhome/account" className="app-sidebar-link">
